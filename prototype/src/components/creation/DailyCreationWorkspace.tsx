...
export function DailyCreationWorkspace() {
  ...
  return <main>
    ...
    <DailyCreationView draft={draft} regenerating={generating} busyAction={busyAction} onSave={save} onFinalize={finalize} onRegenerate={(intent) => void create(intent, draft.runId)} />
  </main>
}

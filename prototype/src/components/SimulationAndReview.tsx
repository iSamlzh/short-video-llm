export function SimulationAndReview({ snapshot, review, onReview, reviewPending = false }: {
  snapshot: any
  review?: any
  onReview?: () => void
  ...
  return <section className="stage-card simulation-card">
    ...
    </div> : onReview ? <button type="button" disabled={reviewPending} onClick={onReview}>
      {reviewPending ? "正在复盘这条内容…" : "生成复盘"}
    </button> : null}
  </section>
}

...
export const prompts = { topics: topicPrompt, scripts: scriptPrompt, qa: qaPrompt, review: reviewPrompt, auto_draft: autoDraftPrompt, topic_draft: topicDraftPrompt } as const

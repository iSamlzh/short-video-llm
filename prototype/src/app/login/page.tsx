...
export default async function LoginPage() {
  ...
  return <main className="login-page">
    ...
    <section className="login-panel"><h2>进入你的内容团队</h2><p>开发验证账号已预填。生产环境不会提供共享默认账号。</p><LoginForm /><details><summary>其他开发角色</summary><p>operator@example.test · reviewer@example.test · platform@example.test</p><p>密码均由本地演示环境变量提供。</p></details></section>
  </main>
}
